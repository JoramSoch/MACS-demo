...
% project directories
stat_dir = 'C:\Joram\projects\MACS\DataSets\Meyer_et_al_2015\analyses\model_selection';
...
subj_ids = {'sub01' 'sub02' 'sub03' 'sub04' 'sub05' 'sub06' 'sub07' 'sub08' 'sub09' 'sub10' ...
            'sub11' 'sub12' 'sub13' 'sub14' 'sub15' 'sub17' 'sub18' 'sub19' 'sub20' ...
            'sub21' 'sub22' 'sub23' 'sub24' 'sub25'};

% list of models
mod_nams = {'GLM_0_0' 'GLM_0_1' 'GLM_1_0' 'GLM_1_1'};

% model space details
ms_name  =  'MS_24subj_4mods';
ms_suff  =  'OHBM_demo';
...
for i = 1:N
    for j = 1:M
        job.models{i}{j}{1} = strcat(work_dir,'/',subj_ids{i},'/','MS_OHBM_2018','/',mod_nams{j},'/','SPM.mat');
    end;
end;
